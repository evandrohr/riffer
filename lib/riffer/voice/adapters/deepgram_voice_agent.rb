...
# Internal adapter for Deepgram Voice Agent provider.
class Riffer::Voice::Adapters::DeepgramVoiceAgent < Riffer::Voice::Adapters::Base
  ...
  #: (model: String, task_resolver: ^() -> untyped, transport_factory: ^(url: String, headers: Hash[String, String]) -> untyped, logger: untyped) -> Riffer::Voice::Drivers::DeepgramVoiceAgent
  def build_driver(model:, task_resolver:, transport_factory:, logger:)
    Riffer::Voice::Drivers::DeepgramVoiceAgent.new(
      model: model,
